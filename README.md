...
| BYOM        | <ul><li> I have my own AI Training Framework, I have created a floating point model. </li>                                                                             | <ul><li>I need help to create a NPU Aware Quantized model                            | :x:                                                                                                                                              | :x:             | <input type="checkbox" disabled checked/> - Refer [this](https://github.com/musicalplatypus/tinyml-tensorlab/blob/main/tinyml-modeloptimization/torchmodelopt/examples/motor_fault_time_series_classification) example.<br/> <ul><li> Follow it up  using [TIs Neural Network Compiler](https://software-dl.ti.com/mctools/nnc/mcu/users_guide/) which can help you get your AI model compatible with TI MCUs. |
...
* ## I'm a User:
  ...
  * <details>
    ...
    ```
    pip install git+https://github.com/musicalplatypus/tinyml-tensorlab.git@platypus_dev#subdirectory=tinyml-modelmaker
    ```
    It is as simple as:
    ```python
